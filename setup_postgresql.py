#!/usr/bin/env python3
"""
PostgreSQL setup script for SutraByte
Run this script to initialize PostgreSQL database with all tables and sample data
"""
...
from app import app, db, User, Skill, Job, JobSkill, Course, CourseSkill, IndustryTrend, SalaryImpact, Certification, Resource, Feedback, Blog
...
def setup_postgresql():
    """Initialize PostgreSQL database with all tables and sample data"""
    ...
    with app.app_context():
        ...
        print("You can now start the application with PostgreSQL.")
