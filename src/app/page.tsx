...
import { ShieldCheck, Target, BookOpenCheck, ListCollapse, ArrowRight } from "lucide-react";
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center">
                <Button asChild size="lg" className="group animate-pulse-glow">
                  <Link href="/skill-analyzer">
                    Analyze Your Skills <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                  </Link>
                </Button>
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3">
              <Card className="bg-card/50 transition-all transform hover:-translate-y-1 hover:shadow-glow hover:border-primary">
                <CardHeader className="flex flex-row items-center gap-4">
                  ...
                  <CardTitle>Skill Analyzer</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">Assess your cybersecurity knowledge and get personalized recommendations to fill your skill gaps.</p>
                </CardContent>
              </Card>
              <Card className="bg-card/50 transition-all transform hover:-translate-y-1 hover:shadow-glow hover:border-primary">
                <CardHeader className="flex flex-row items-center gap-4">
